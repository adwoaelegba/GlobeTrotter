...
<header >
    ...
    <div class="card-container">
        ...
        <div class="card">
            <img src="../images/independence.jpeg" alt="">
            <div class="content">
                <h3>Ghana</h3>
    ...
    <div class="card-container">
        ...
        <div class="card">
            <img src="../images/turkiye.jpg" alt="">
            <div class="content">
                <h3>Turkiye</h3>
 ...
 <h2 class="continent">Europe</h2>
    <div class="card-container">
        ...
        <div class="card">
            <img src="../images/southfrance.jpg" alt="">
            <div class="content">
                <h3>France</h3>
    ...
    <!--fourth row-->
 <h2 class="continent">Carribean</h2>
    <div class="card-container">
    
        <div class="card">
            <img src="../images/jamparade.jpg" alt="">
            <div class="content">
                <h3>Jamaica</h3>
        ...
        <div class="card">
            <img src="../images/stlucia.jpg" alt="">
            <div class="content">
                <h3>St. Lucia</h3>
                <p>This beauty queen of the Caribbean invites you to step into adventure and inspiration.
                     Let her captivating coastline and warm hospitality leave you spellbound. 
        ...
        <!--third-->
        <div class="card">
            <img src="../images/Barbados-Holetown.jpg" alt="">
            <div class="content">
                <h3>Barbados</h3>
